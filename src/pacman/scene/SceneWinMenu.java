...
public class SceneWinMenu implements ScenePacMan {
    ...
    public Scene getScene() {
        ...
        setupScene.setImageView(picturePacMan, 400, -80, 400, 400, new Image(new File("ressources/textures/menu_logo.png").toURI().toString()), true);

        buttonOption.setOnMouseClicked((event) -> setSceneOption());
        buttonQuit.setOnMouseClicked((event) -> setSceneMainMenu());

        pane.getChildren().addAll(buttonOption, buttonQuit, picturePacMan);
